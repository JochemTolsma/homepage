...
If you want to graphically depict a moderation, it may be useful to show the model without the moderator as well but this is a bit a matter of taste.  
...
#interaction variable educ*age
nellsw2$cm_educ_age <- nellsw2$cm_education_c * nellsw2$cm_age_c
...
model <- '
  cm_health~1   
  cm_health~a*cm_education_c  
  cm_health~d*cm_age_c   
  cm_health~b*cm_educ_age 
  cm_health~~cm_health
  
  '


fit <- lavaan(model, data = nellsw2) 
